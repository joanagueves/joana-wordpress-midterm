...
<div class = "wall">
	<div class="insidect">
	  	...
	  	<li>		
    		...
    		<input type="text" id="fname" name="firstname" placeholder="First Name"style="width:1200px">
    	</li>
        <li>        
            <label for="lname">Last Name</label>
            <input type="text" id="lname" name="lastname" placeholder="Last Name"style="width:1200px">
        </li>
    	<li>
